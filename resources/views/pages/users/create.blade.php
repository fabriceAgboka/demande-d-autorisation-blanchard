<div class="modal modal-slide-in sidebar-todo-modal fade" id="addUserModal">
    <div class="modal-dialog sidebar-lg">
        <div class="modal-content p-0">
            <form class="add-new-record modal-content pt-0" id="addUserForm" method="POST">
                <div class="modal-header align-items-center mb-1">
                    <h5 class="modal-title">Ajouter un administrateurs</h5>
                ...
                <div class="modal-body flex-grow-1">
                    <div class="form-group mt-1">
                        ...
                        <input type="text" id="store_nom" name="nom" class="form-control" />
                        <small class="text-danger font-size-xsmall error_nom hidden"></small>
                    </div>

                    <div class="form-group mt-1">
                        <label for="prenom" class="form-label">Prénom</label>
                        <input type="text" id="store_prenom" name="prenom" class="form-control" />
                    ...
                    <div class="form-group mt-1">
                        ...
                        <input type="text" id="store_phone" name="phone" class="form-control" />
